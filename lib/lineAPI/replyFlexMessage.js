...
const postFlexMessage = async (lineBotToken, userId, address) =>{
    ...
    try{
        ...
        flexMessage['contents']['body']['contents'][2]['contents'][0]['contents'][1]['data'] = flexMessage['contents']['body']['contents'][2]['contents'][0]['contents'][1]['data'].concat(address);
        console.log(`replyFlexMessage address = ${flexMessage['contents']['body']['contents'][2]['contents'][0]['contents'][1]['data']}`)
        let options = await {
            method: 'POST',
