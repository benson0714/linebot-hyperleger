...
const coinOptions = require('./../hyperledgerAPI/coinOptions.js');
const getAddressAPI = require('./../hyperledgerAPI/getAddress.js');
...
const replyPostback = async (events, lineBotToken) => {
    ...
    if (action[1] === 'replyFlexMessage') {
        ...
        if (string[1].split('=')[1] === 'send') {
            ...
            let message = await getAddressAPI.getAddress(userId, lineBotToken);
            return message;
        }
    }
}
